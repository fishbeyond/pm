...
--
-- Dumping data for table `project_user_mapper`
--

LOCK TABLES `project_user_mapper` WRITE;
/*!40000 ALTER TABLE `project_user_mapper` DISABLE KEYS */;
/*!40000 ALTER TABLE `project_user_mapper` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-05 10:06:32
